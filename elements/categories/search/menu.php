...
<div class="row row-cols-auto g-0 align-items-center">
    ...
    <ul class="ccm-dashboard-header-icons">
        <li>
            <a  class="ccm-hover-icon launch-tooltip" title="<?php echo h(t('Add Category')) ?>" href="<?php echo \Concrete\Core\Support\Facade\Url::to("/dashboard/bitter_shop_system/products/categories/add"); ?>">
