...
<div class="row row-cols-auto g-0 align-items-center">
    ...
    <ul class="ccm-dashboard-header-icons">
        <li>
            <a  class="ccm-hover-icon launch-tooltip" title="<?php echo h(t('Add Product')) ?>" href="<?php echo \Concrete\Core\Support\Facade\Url::to("/dashboard/bitter_shop_system/products/add"); ?>">
                <i class="fas fa-plus" aria-hidden="true"></i>
            </a>
        </li>

        <li>
            <a  class="ccm-hover-icon launch-tooltip" title="<?php echo h(t('Manage Attributes')) ?>" href="<?php echo \Concrete\Core\Support\Facade\Url::to("/dashboard/bitter_shop_system/products/attributes"); ?>">
