...
class LimitQuantityColumn extends Column implements PagerColumnInterface
{
    public function getColumnKey()
    {
        return 't5.limitQuantity';
    }
    ...
    {
        return [Manager::class, 'getLimitQuantity'];
    }
    ...
    public function filterListAtOffset(PagerProviderInterface $itemList, $mixed)
    {
        ...
        $where = sprintf('t5.limitQuantity %s :limitQuantity', $sort);
        $query->setParameter('limitQuantity', $mixed->getLimitQuantity());
