...
class PriceRegularColumn extends Column implements PagerColumnInterface
{
    public function getColumnKey()
    {
        return 't2.priceRegular';
    }
    ...
    public function filterListAtOffset(PagerProviderInterface $itemList, $mixed)
    {
        ...
        $where = sprintf('t2.price_regular %s :price_regular', $sort);
        $query->setParameter('price_regular', $mixed->getPriceRegular());
