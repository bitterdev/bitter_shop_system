...
class ShippingCostListPagerManager extends AbstractPagerManager
{
    /** 
     * @param ShippingCost $shippingCost
     * @return int 
     */
    public function getCursorStartValue($shippingCost)
    {
    ...
    public function getCursorObject($cursor)
    {
        ...
        return $entityManager->getRepository(ShippingCost::class)->findOneBy(["id" => $cursor]);
    }
    ...
    public function sortListByCursor(PagerProviderInterface $itemList, $direction)
    {
        ...
        $itemList->getQueryObject()->addOrderBy('t1.id', $direction);
    }
}
