...
class CustomerListPagerManager extends AbstractPagerManager
{
    /** 
     * @param Customer $customer
     * @return int 
     */
    public function getCursorStartValue($customer)
    {
    ...
    public function getCursorObject($cursor)
    {
        ...
        return $entityManager->getRepository(Customer::class)->findOneBy(["id" => $cursor]);
    }
    ...
    public function sortListByCursor(PagerProviderInterface $itemList, $direction)
    {
        ...
        $itemList->getQueryObject()->addOrderBy('t3.id', $direction);
    }
}
