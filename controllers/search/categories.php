...
use Concrete\Package\BitterShopSystem\Controller\Dialog\Categories\AdvancedSearch;

class Categories extends Standard
{
    /**
     ...
     * @param int $presetID
     *
     * @return SavedCategorySearch|null
     */
    protected function getSavedSearchPreset($presetID)
    {
        $em = $this->app->make(EntityManagerInterface::class);
        return $em->find(SavedCategorySearch::class, $presetID);
    }
