...
use Concrete\Package\BitterShopSystem\Controller\Dialog\Orders\AdvancedSearch;

class Orders extends Standard
{
    /**
     ...
     * @param int $presetID
     *
     * @return SavedOrderSearch|null
     */
    protected function getSavedSearchPreset($presetID)
    {
        $em = $this->app->make(EntityManagerInterface::class);
        return $em->find(SavedOrderSearch::class, $presetID);
    }
