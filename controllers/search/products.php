...
use Concrete\Package\BitterShopSystem\Controller\Dialog\Products\AdvancedSearch;
...
class Products extends Standard
{
     ...
     * @param int $presetID
     *
     * @return SavedProductSearch|null
     */
    protected function getSavedSearchPreset($presetID)
    {
        $em = $this->app->make(EntityManagerInterface::class);
        return $em->find(SavedProductSearch::class, $presetID);
    }
