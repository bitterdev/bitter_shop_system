...
use Concrete\Package\BitterShopSystem\Controller\Dialog\Coupons\AdvancedSearch;

class Coupons extends Standard
{
    /**
     ...
     * @param int $presetID
     *
     * @return SavedCouponSearch|null
     */
    protected function getSavedSearchPreset($presetID)
    {
        $em = $this->app->make(EntityManagerInterface::class);
        return $em->find(SavedCouponSearch::class, $presetID);
    }
