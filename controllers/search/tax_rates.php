...
use Concrete\Package\BitterShopSystem\Controller\Dialog\TaxRates\AdvancedSearch;

class TaxRates extends Standard
{
    /**
     ...
     * @param int $presetID
     *
     * @return SavedTaxRateSearch|null
     */
    protected function getSavedSearchPreset($presetID)
    {
        $em = $this->app->make(EntityManagerInterface::class);
        return $em->find(SavedTaxRateSearch::class, $presetID);
    }
