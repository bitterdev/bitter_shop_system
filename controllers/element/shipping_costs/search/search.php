...
namespace Concrete\Package\BitterShopSystem\Controller\Element\ShippingCosts\Search;
...
class Search extends ElementController
{
    ...
    {
        return 'shipping_costs/search/search';
    }
    ...
    public function view()
    {
        ...
        if (isset($this->headerSearchAction)) {
            ...
            $this->set('headerSearchAction', $this->app->make('url')->to('/dashboard/bitter_shop_system/shipping_costs'));
        }
