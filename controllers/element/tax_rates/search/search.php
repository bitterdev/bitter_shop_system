...
namespace Concrete\Package\BitterShopSystem\Controller\Element\TaxRates\Search;
...
class Search extends ElementController
{
    ...
    {
        return 'tax_rates/search/search';
    }
    ...
    public function view()
    {
        ...
        if (isset($this->headerSearchAction)) {
            ...
            $this->set('headerSearchAction', $this->app->make('url')->to('/dashboard/bitter_shop_system/tax_rates'));
        }
