...
namespace Concrete\Package\BitterShopSystem\Controller\Element\Coupons\Search;
...
class Search extends ElementController
{
    ...
    public function view()
    {
        ...
        if (isset($this->headerSearchAction)) {
            ...
            $this->set('headerSearchAction', $this->app->make('url')->to('/dashboard/bitter_shop_system/coupons'));
        }
