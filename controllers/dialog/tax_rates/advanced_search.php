...
class AdvancedSearch extends AdvancedSearchController
{
    ...
    public function getSearchPresets()
    {
        ...
        if (is_object($em)) {
            return $em->getRepository(SavedTaxRateSearch::class)->findAll();
        }
    }
    ...
    {
        return $this->app->make('url')->to('/dashboard/bitter_shop_system/tax_rates', 'advanced_search');
    }
    ...
    {
        return $this->app->make('url')->to('/dashboard/bitter_shop_system/tax_rates', 'preset', $search->getID());
    }

    public function getSavedSearchDeleteURL(SavedSearch $search)
    {
        return (string)Url::to('/ccm/system/dialogs/tax_rates/bitter_shop_system/preset/delete?presetID=' . $search->getID());
    }
    ...
    {
        return (string)Url::to('/ccm/system/search/tax_rates/current');
    }
