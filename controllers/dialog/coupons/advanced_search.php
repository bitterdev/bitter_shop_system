...
class AdvancedSearch extends AdvancedSearchController
{
    ...
    public function getSavedSearchEntity()
    {
        ...
        if (is_object($em)) {
            return $em->getRepository(SavedCouponSearch::class);
        }
    ...
    {
        return (string) Url::to('/ccm/system/search/coupons/preset', $search->getID());
    }
    
    public function getCurrentSearchBaseURL()
    {
        return Url::to('/ccm/system/search/coupons/current');
    }
    
    public function getBasicSearchBaseURL()
    {
        return Url::to('/ccm/system/search/coupons/basic');
    }
    
    public function getSavedSearchDeleteURL(SavedSearch $search)
    {
        return (string) Url::to('/ccm/system/dialogs/coupons/advanced_search/preset/delete?presetID=' . $search->getID());
    }
