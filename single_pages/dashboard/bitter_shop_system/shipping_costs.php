...
use Bitter\BitterShopSystem\ShippingCost\Search\Result\Column;
use Bitter\BitterShopSystem\ShippingCost\Search\Result\Result;
use Bitter\BitterShopSystem\ShippingCost\Search\Result\Item;
use Bitter\BitterShopSystem\ShippingCost\Search\Result\ItemColumn;
use Bitter\BitterShopSystem\ShippingCost\Menu;
...
<div id="ccm-search-results-table">
    <table class="ccm-search-results-table" data-search-results="shippingCosts">
        <thead>
        <tr>
        ...
        <?php foreach ($result->getItems() as $item) { ?>
            ...
            $shippingCost = $item->getItem();
            ?>
            <tr data-details-url="<?php echo Url::to('/dashboard/bitter_shop_system/shipping_costs', 'update', $shippingCost->getId()) ?>">
                <td class="ccm-search-results-checkbox">
                    <?php if ($shippingCost instanceof ShippingCost) { ?>
                        <!--suppress HtmlFormInputWithoutLabel -->
                        <input data-search-checkbox="individual"
                               type="checkbox"
                               data-item-id="<?php echo $shippingCost->getId() ?>"/>
                    <?php } ?>
                </td>
                ...
                <?php $menu = new Menu($shippingCost); ?>
...
<div style="display: none">
    <div id="ccm-dialog-delete-shippingCost" class="ccm-ui">
        <p>
