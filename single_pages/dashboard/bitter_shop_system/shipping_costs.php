        ...
        <div class="popover fade" data-search-menu="<%=item.id%>">
            ...
            <div class="popover-inner">
                <ul class="dropdown-menu">
                    <li>
                        <a href="<?php echo Url::to("/dashboard/bitter_shop_system/shipping_costs/edit"); ?>/<%=item.id%>">
                            <?php echo t("Edit"); ?>
                        </a>
                    </li>

                    <li>
                        <a href="<?php echo Url::to("/dashboard/bitter_shop_system/shipping_costs/remove"); ?>/<%=item.id%>">
                            <?php echo t("Remove"); ?>
                        </a>
                    </li>
                </ul>
