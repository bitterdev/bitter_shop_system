...
use Bitter\BitterShopSystem\Coupon\Search\Result\Column;
use Bitter\BitterShopSystem\Coupon\Search\Result\Result;
use Bitter\BitterShopSystem\Coupon\Search\Result\Item;
use Bitter\BitterShopSystem\Coupon\Search\Result\ItemColumn;
use Bitter\BitterShopSystem\Coupon\Menu;
...
<div id="ccm-search-results-table">
    <table class="ccm-search-results-table" data-search-results="coupons">
        <thead>
        <tr>
        ...
        <?php foreach ($result->getItems() as $item) { ?>
            ...
            $coupon = $item->getItem();
            ?>
            <tr data-details-url="<?php echo Url::to('/dashboard/bitter_shop_system/coupons', 'update', $coupon->getId()) ?>">
                <td class="ccm-search-results-checkbox">
                    <?php if ($coupon instanceof Coupon) { ?>
                        <!--suppress HtmlFormInputWithoutLabel -->
                        <input data-search-checkbox="individual"
                               type="checkbox"
                               data-item-id="<?php echo $coupon->getId() ?>"/>
                    <?php } ?>
                </td>
...
<div style="display: none">
    <div id="ccm-dialog-delete-coupon" class="ccm-ui">
        <p>
