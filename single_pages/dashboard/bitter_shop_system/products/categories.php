...
use Bitter\BitterShopSystem\Category\Search\Result\Column;
use Bitter\BitterShopSystem\Category\Search\Result\Result;
use Bitter\BitterShopSystem\Category\Search\Result\Item;
use Bitter\BitterShopSystem\Category\Search\Result\ItemColumn;
use Bitter\BitterShopSystem\Category\Menu;
...
<div id="ccm-search-results-table">
    <table class="ccm-search-results-table" data-search-results="categories">
        ...
        <?php foreach ($result->getItems() as $item) { ?>
            ...
            ?>
            <tr data-details-url="<?php echo Url::to('/dashboard/bitter_shop_system/products/categories', 'update', $category->getId()) ?>">
                <td class="ccm-search-results-checkbox">
                    <?php if ($category instanceof Category) { ?>
                        <!--suppress HtmlFormInputWithoutLabel -->
                        <input data-search-checkbox="individual"
                               type="checkbox"
                               data-item-id="<?php echo $category->getId() ?>"/>
                    <?php } ?>
                </td>
...
<div style="display: none">
    <div id="ccm-dialog-delete-category" class="ccm-ui">
        <p>
