...
use Bitter\BitterShopSystem\Customer\Search\Result\Column;
use Bitter\BitterShopSystem\Customer\Search\Result\Result;
use Bitter\BitterShopSystem\Customer\Search\Result\Item;
use Bitter\BitterShopSystem\Customer\Search\Result\ItemColumn;
use Bitter\BitterShopSystem\Customer\Menu;
...
<div id="ccm-search-results-table">
    <table class="ccm-search-results-table" data-search-results="customers">
        <thead>
        <tr>
        ...
        <?php foreach ($result->getItems() as $item) { ?>
            ...
            ?>
            <tr data-details-url="<?php echo Url::to('/dashboard/bitter_shop_system/customers', 'update', $customer->getId()) ?>">
                <td class="ccm-search-results-checkbox">
                    <?php if ($customer instanceof Customer) { ?>
                        <!--suppress HtmlFormInputWithoutLabel -->
                        <input data-search-checkbox="individual"
                               type="checkbox"
                               data-item-id="<?php echo $customer->getId() ?>"/>
                    <?php } ?>
                </td>
...
<div style="display: none">
    <div id="ccm-dialog-delete-customer" class="ccm-ui">
        <p>
