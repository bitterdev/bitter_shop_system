...
use Bitter\BitterShopSystem\Order\Search\Result\Column;
use Bitter\BitterShopSystem\Order\Search\Result\Result;
use Bitter\BitterShopSystem\Order\Search\Result\Item;
use Bitter\BitterShopSystem\Order\Search\Result\ItemColumn;
use Bitter\BitterShopSystem\Order\Menu;
...
<div id="ccm-search-results-table">
    <table class="ccm-search-results-table" data-search-results="orders">
        <thead>
        <tr>
                ...
                <td class="ccm-search-results-checkbox">
                    <?php if ($order instanceof Order) { ?>
                        ...
                        <input data-search-checkbox="individual"
                               type="checkbox"
                               data-item-id="<?php echo $order->getId() ?>"/>
                    <?php } ?>
                </td>
...
<div style="display: none">
    <div id="ccm-dialog-delete-order" class="ccm-ui">
        <p>
